...
while True:
    ...
    for rect in rects:
        ...
        # Increment total_frames and check for accuracy
        total_frames += 1
        predicted_label = 1 if ear < EYE_THRESH or mar > MOU_THRESH else 0

        # Assuming you have ground truth labels (replace ground_truth_label with actual labels)
        ground_truth_label = 1  # Replace this with the actual ground truth label
    ...
    if key == ord("q"):
        # Calculate accuracy before breaking the loop
